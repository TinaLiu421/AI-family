...
class qaq:
    def __init__(self,
        ...
        try:
            ...
            if not self.stream:
                print(response)
            print('Initialization succeeded...', file=sys.stderr)
...
os.environ['COZE_API_TOKEN'] = 'pat_GpVah7cvbNmsBRynUFhZqrwbaG6DMZxsmlgKyjphgfW7OEGhcS4dKKDMbNtPVXHG'
os.environ['COZE_BOT_ID'] = '7486383496274559011'
chat = qaq(api_token=os.environ['COZE_API_TOKEN'],
           bot_id=os.environ['COZE_BOT_ID'],
           max_chat_rounds=20,
           stream=True)
a=input()
response = chat.chat(a)
print(response)